...
class _Register implements AuthEvent {
  const _Register(this.email, this.password, this.name, this.avatarUrl, this.username);
...
@override
int get hashCode => Object.hash(runtimeType,email,password,name,avatarUrl,username);

@override
String toString() {
  return 'AuthEvent.register(email: $email, password: $password, name: $name, avatarUrl: $avatarUrl, username: $username)';
}
...
@useResult
$Res call({
 String email, String password, String? name, String? avatarUrl, String? username
});
...
/// Create a copy of AuthEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? name = freezed,Object? avatarUrl = freezed,Object? username = freezed,}) {
  return _then(_Register(
null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String,null == password ? _self.password : password // ignore: cast_nullable_to_non_nullable
as String,freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,freezed == avatarUrl ? _self.avatarUrl : avatarUrl // ignore: cast_nullable_to_non_nullable
